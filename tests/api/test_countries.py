...
class TestCountrysAPI(TestBaseServer):
    ...
    def test_get_countries(self):
        self.assert404("/adele/api/1.0/countries/100")

        r = self.assert200('/adele/api/1.0/countries')
        r = json_loads(r.data)["data"]
        self.assertEqual(4, len(r))

        r = self.assert200('/adele/api/1.0/countries/1')
        r = json_loads(r.data)["data"]
        self.assertEqual("France", r[0]["label"])

    def test_delete_countries(self):
        self.assert403("/adele/api/1.0/countries", method="DELETE")
        self.assert403("/adele/api/1.0/countries", method="DELETE", **STU1_USER)
        self.assert200("/adele/api/1.0/countries/126436", method="DELETE", **ADMIN_USER)

        self.assert200("/adele/api/1.0/countries/1", method="DELETE", **ADMIN_USER)
    ...
    def test_put_countries(self):
        self.assert403("/adele/api/1.0/countries", data={"data": {}},  method="PUT")
        self.assert403("/adele/api/1.0/countries", data={"data": {}},  method="PUT", **STU1_USER)
        self.assert409("/adele/api/1.0/countries", data={"data": [{"id": 100}]},  method="PUT", **ADMIN_USER)

        self.assert200("/adele/api/1.0/countries", data={"data": [{"id": 1, "label": "PapeTest"}]}, method="PUT", **ADMIN_USER)
        r = self.assert200('/adele/api/1.0/countries/1')
        r = json_loads(r.data)["data"]
        self.assertEqual("PapeTest", r[0]["label"])

        self.assert200("/adele/api/1.0/countries", data={"data": [{"id": 1, "ref": "Desc2"}]}, method="PUT", **ADMIN_USER)
        r = self.assert200('/adele/api/1.0/countries/1')
        r = json_loads(r.data)["data"]
    ...
    def test_api_post_country(self):
        ...
        r = self.assert200('/adele/api/1.0/countries/500')
        r = json_loads(r.data)["data"]
        ...
        self.assert200("/adele/api/1.0/countries",
                       ...
                       **PROF1_USER)
        self.assert200('/adele/api/1.0/countries/501')
        self.assert200('/adele/api/1.0/countries/502')
